...
| Advancing tourism demand forecasting in Sri Lanka: ML models + social-media data (Hewapathirana) | J. Tourism Futures 11(2):261, online 2023-12-15 / print 2025 | https://doi.org/10.1108/JTF-06-2023-0149 | National arrivals covariate — **replaces the dead/unverifiable RG 392533688 citation** |
...
| Do We Really Need GCNs in Traffic Forecasting? A Graph-Less Pure-MLP Architecture (Zhang et al.) | ACM WWW '25 Companion, 2025 | https://doi.org/10.1145/3701716.3715464 | Peer-reviewed empirical evidence graph structure doesn't automatically beat a graph-free model — strongest direct support for the §5.5 falsifiable hypothesis |
| Contextualized ST graph method for forecasting sparse geospatial sensor networks (Uremović et al.) | Expert Systems with Applications 294:128779, 2025 | https://doi.org/10.1016/j.eswa.2025.128779 | Sparse-graph forecasting precedent (geospatial, not urban) |
| GNN for traffic density on unmonitored roads from very few scattered measurements (Acciai et al.) | Expert Systems with Applications 327:132713, 2026 | https://doi.org/10.1016/j.eswa.2026.132713 | Structural analogy to Module 4's few-calibration-point situation |
...
| Enhancing crowd management via behaviourally-informed synthetic datasets + predictive DL (Gayathri et al.) | Results in Engineering 28:108210, 2025 | https://doi.org/10.1016/j.rineng.2025.108210 | Closest precedent to the permit-cap × seasonality × movement-model synthetic pipeline |
...
| Visitor Number Prediction for Daegwallyeong Forest Trail Using ML (Ryu et al.) | Sustainability 17(13):6061, 2025 | https://doi.org/10.3390/su17136061 | Direct-domain forest-trail visitor forecasting; weather+calendar feature-design precedent |
| Landscape Drivers of Trail Formation … Explainable ML (Guo et al.) | Land 15(5):715, 2026 | https://doi.org/10.3390/land15050715 | Validates slope/elevation/**TWI** as trail/hiker-behaviour ML covariates |
...
| Limits of Acceptable Change (LAC) System for Wilderness Planning (Stankey et al.) | **USDA Forest Service GTR-INT-176, 1985 — foundational/classical exception (rule #4): the named LAC method, same basis as the Cifuentes 1992 exception** | https://research.fs.usda.gov/treesearch/66741 | Theoretical grounding for why a dynamic/condition-based ECC beats a static permit quota |
| Managing Tourism and Environment — Trail Erosion, TPC and LAC (Dragovich & Bajpai) | Sustainability 14(7):4291, 2022 | https://doi.org/10.3390/su14074291 | Recent empirical LAC/TPC application to trail erosion — pairs with the Stankey foundational cite |
| Carrying capacity and strategic planning for sustainable tourism, Char Dham, Western Himalaya (Kuniyal et al.) | Scientific Reports 15:36340, 2025-10-17 | https://doi.org/10.1038/s41598-025-20166-8 | South Asian mountain-trekking carrying-capacity problem-framing precedent (MCDA/AHP method — not Cifuentes; problem-framing only, not methodological) |
| Carrying capacity in human-environment interactions: a systematic review (DuPuy, Galaitsi, Linkov) | Integrated Environmental Assessment and Management 21(3):526–539, 2025 | https://doi.org/10.1093/inteam/vjaf021 | Confirms Cifuentes cascade remains current best practice, not superseded — supports the foundational-exception citation choice |
| Transfer Learning With Spatial–Temporal GCN for Traffic Prediction, Ada-STGCN (Yao et al.) | IEEE Trans. Intelligent Transportation Systems 24(8):8592–8605, 2023 | https://doi.org/10.1109/TITS.2023.3250424 | Precedent for pretraining on data-rich benchmarks (METR-LA/PEMS) then transferring to a data-scarce target graph (Horton Plains) |
| UQGNN: Uncertainty Quantification of GNNs for Multivariate Spatiotemporal Prediction (Yu et al.) | ACM SIGSPATIAL '25, 2025-11-03 | https://doi.org/10.1145/3748636.3762709 | Joint mean + uncertainty prediction precedent — a point forecast alone is insufficient for a capacity decision |
| Uncertainty Quantification for Traffic Forecasting Using Deep-Ensemble ST-GNNs (Mallick, Macfarlane, Balaprakash) | IEEE Trans. Intelligent Transportation Systems 25(8):9141–9152, 2024 | https://doi.org/10.1109/TITS.2024.3381099 | Deep-ensemble uncertainty quantification precedent for ST-GNN forecasts |
| CONTINA: Confidence Interval for Traffic Demand Prediction with Coverage Guarantee (Yang et al.) | Transportation Research Part C 184:105502, 2025/2026 | https://doi.org/10.1016/j.trc.2025.105502 | Distribution-free (conformal) confidence intervals — fits a low-count, over-dispersed target better than a Gaussian assumption |
| DG-STMTL: Multi-Task Spatio-Temporal Traffic Forecasting (Cui, Wang, Yin) | arXiv:2504.07822, 2025 — **preprint, peer-review status unconfirmed** | https://arxiv.org/abs/2504.07822 | Multi-task shared-backbone forecasting precedent, structurally analogous to a forecast+downstream-cascade design |
